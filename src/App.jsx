      ...
      <div className="max-w-[1500px] mx-auto">
        <div className="flex items-center mb-4 gap-3">
          ...
          <div className="flex flex-col items-end ml-auto select-none">
            <span className="text-[11px] font-semibold tracking-widest text-[var(--text-muted)] uppercase">
              Gradient Fitter
            </span>
            <span className="hidden sm:block text-[9px] font-normal tracking-wider text-[var(--text-muted)] opacity-60 normal-case">
              Fit image colors to gradient functions
            </span>
          </div>
          <a
              ...
              <>
                <div className="bg-[var(--surface)] p-5 space-y-5">
                  ...
                  <LineModeSettings
                    ...
                    degree={degree}
                    setDegree={setDegree}
                    lockFrequency={lineLockFrequency}
                    setLockFrequency={setLineLockFrequency}
                  />
                </div>
